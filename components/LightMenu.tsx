...
const LightMenu = () => {
  return (
    <View style={styles.lightMenu}>
      <View style={[styles.billLight, styles.lightBorder]}>
      ...
      <View style={[styles.incomeLight, styles.lightBorder]}>
      ...
      <View style={[styles.deptLight, styles.lightBorder]}>
        <View style={[styles.view4, styles.viewPosition1]}>
          ...
          <Image
            style={[styles.tableIcon, styles.gasPosition]}
            contentFit="cover"
            source={require("../assets/table3.png")}
          />
          <Image
            style={styles.btnIconPosition}
            contentFit="cover"
        ...
        <View style={[styles.property112, styles.propertyLayout]}>
          ...
          <Image
            ...
            source={require("../assets/vector10.png")}
          />
          <Text style={[styles.bill1, styles.billTypo]}>Dept</Text>
          <View style={[styles.property11Item, styles.gasPosition]} />
        </View>
      </View>
    </View>
